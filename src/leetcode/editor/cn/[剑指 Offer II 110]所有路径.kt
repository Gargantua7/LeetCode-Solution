...
//target/ 
// Related Topics 深度优先搜索 广度优先搜索 图 回溯 👍 5 👎 0
...
class BP4bmD {
    ...
    class Solution {
        fun allPathsSourceTarget(graph: Array<IntArray>): List<List<Int>> {
            ...
            dfs(graph, ans, ArrayList(), 0)
            return ans
        }

        fun dfs(graph: Array<IntArray>, ans: ArrayList<List<Int>>, temp: ArrayList<Int>, curr: Int) {
            temp.add(curr)
            if (curr == graph.lastIndex) {
