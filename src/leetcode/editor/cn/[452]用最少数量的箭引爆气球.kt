...
class Solution {
    fun findMinArrowShots(points: Array<IntArray>): Int {
        points.sortBy { it[0] }
        var ans = 1
        var interval = Int.MIN_VALUE..Int.MAX_VALUE
        points.forEach { (l, r) ->
            interval = when {
                interval in l..r -> interval
                l..r in interval -> l..r
                l in interval -> l..interval.last
                r in interval -> interval.first..r
                else -> {
                    ans++
                    l..r
                }
